...
export const REQUIRED_MESSAGES: { [E in EntityKey]?: Partial<Record<MessageFieldKey<E>, string>> } = {
  ...
  kurse: { titel: "Bitte den Kurstitel eingeben.", dozent: "Bitte einen Dozenten auswählen.", beginn: "Bitte das Kursbeginn-Datum wählen.", maximale_teilnehmer: "Bitte die maximale Teilnehmerzahl angeben.", status: "Bitte den Kursstatus wählen." },
  ...
  anwesenheiten: { kurs: "Bitte einen Kurs auswählen.", teilnehmer: "Bitte einen Schüler auswählen.", datum: "Bitte das Datum der Stunde eingeben." },
  // </custom:messages>
};
