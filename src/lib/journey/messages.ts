...
export const REQUIRED_MESSAGES: { [E in EntityKey]?: Partial<Record<MessageFieldKey<E>, string>> } = {
  ...
  kurse: { titel: "Bitte einen Kurstitel eingeben.", instrument: "Bitte ein Instrument wählen.", dozent: "Bitte einen Dozenten zuweisen.", beginn: "Bitte das Startdatum des Kurses wählen.", maximale_teilnehmer: "Bitte die maximale Teilnehmerzahl angeben.", status: "Bitte den Status des Kurses wählen." },
  teilnehmer: { vorname: "Bitte den Vornamen des Kindes eingeben.", nachname: "Bitte den Nachnamen des Kindes eingeben." },
  anmeldungen: { kurs: "Bitte einen Kurs auswählen.", teilnehmer: "Bitte einen Teilnehmer auswählen.", anmeldedatum: "Bitte das Anmeldedatum eingeben.", status: "Bitte den Anmeldestatus wählen." },
  anwesenheiten: { kurs: "Bitte einen Kurs auswählen.", teilnehmer: "Bitte einen Teilnehmer auswählen.", datum: "Bitte das Datum der Stunde eingeben." },
  // </custom:messages>
};
