...
export const INTENTS: IntentLink[] = [
  // <custom:intents>
  { path: '/intents/schueler-anmelden', label: { de: 'Schüler anmelden', en: 'Enrol student' }, icon: IconUserPlus, description: 'Schüler zu einem Kurs anmelden oder auf die Warteliste setzen' },
  { path: '/intents/anwesenheit-erfassen', label: { de: 'Anwesenheit erfassen', en: 'Record attendance' }, icon: IconClipboardCheck, description: 'Anwesenheit aller Schüler einer Kursstunde auf einmal erfassen' },
  { path: '/intents/kurs-planen', label: { de: 'Kurs planen', en: 'Plan course' }, icon: IconCalendarPlus, description: 'Neuen Kurs anlegen mit Dozenten und Raum mit ausreichend Plätzen' },
  // </custom:intents>
];
 ...
 */
export const INTENTS_PENDING_SINCE: string | null = '2026-09-07T10:57:29+00:00';
