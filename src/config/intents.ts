...
export const INTENTS: IntentLink[] = [
  // <custom:intents>
  { path: '/intents/schueler-anmelden', label: { de: 'Schüler anmelden', en: 'Enrol student' }, icon: IconUserPlus, description: 'Schüler suchen oder neu anlegen und für einen Kurs anmelden' },
  { path: '/intents/anwesenheit-erfassen', label: { de: 'Anwesenheit erfassen', en: 'Record attendance' }, icon: IconClipboardCheck, description: 'Anwesenheit aller angemeldeten Schüler für eine Kursstunde auf einmal erfassen' },
  { path: '/intents/kurs-planen', label: { de: 'Kurs planen', en: 'Plan course' }, icon: IconCalendarPlus, description: 'Neuen Kurs anlegen und Dozenten sowie Raum mit genug Plätzen zuweisen' },
  // </custom:intents>
];
 ...
 */
export const INTENTS_PENDING_SINCE: string | null = '2026-09-07T15:36:24+00:00';
