...
export const INTENTS: IntentLink[] = [
  // <custom:intents>
  { path: '/intents/schueler-anmelden', label: { de: 'Schüler anmelden', en: 'Enrol student' }, icon: IconUserPlus, description: 'Schüler einem Kurs anmelden oder auf die Warteliste setzen' },
  ...
  { path: '/intents/kurs-planen', label: { de: 'Kurs planen', en: 'Plan course' }, icon: IconCalendarPlus, description: 'Neuen Kurs für einen Dozenten mit passendem Raum planen' },
  // </custom:intents>
];
 ...
 */
export const INTENTS_PENDING_SINCE: string | null = '2026-09-07T14:48:32+00:00';
