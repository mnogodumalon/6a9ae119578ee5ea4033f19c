...
export const INTENTS: IntentLink[] = [
  // <custom:intents>
  { path: '/intents/schueler-anmelden', label: { de: 'Schüler anmelden', en: 'Enrol student' }, icon: IconUserPlus, description: 'Schüler suchen oder anlegen und für einen Kurs anmelden' },
  { path: '/intents/anwesenheit-erfassen', label: { de: 'Anwesenheit erfassen', en: 'Record attendance' }, icon: IconClipboardCheck, description: 'Anwesenheit aller Schüler eines Kurses für eine Stunde eintragen' },
  { path: '/intents/kurs-planen', label: { de: 'Kurs planen', en: 'Plan course' }, icon: IconCalendarPlus, description: 'Neuen Kurs anlegen: Dozent wählen, Raum mit passender Kapazität wählen, Kursdetails eingeben' },
  // </custom:intents>
];
 ...
 */
export const INTENTS_PENDING_SINCE: string | null = '2026-09-07T11:36:47+00:00';
