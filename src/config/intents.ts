...
export const INTENTS: IntentLink[] = [
  ...
  { path: '/intents/anwesenheit-erfassen', label: { de: 'Anwesenheit erfassen', en: 'Record attendance' }, icon: IconClipboardCheck, description: 'Anwesenheit aller Schüler eines Kurses für eine Stunde erfassen' },
  { path: '/intents/kurs-planen', label: { de: 'Kurs planen', en: 'Plan course' }, icon: IconCalendarPlus, description: 'Neuen Kurs anlegen und einen Raum mit ausreichend Plätzen zuweisen' },
  // </custom:intents>
];
 ...
 */
export const INTENTS_PENDING_SINCE: string | null = '2026-09-07T09:53:28+00:00';
