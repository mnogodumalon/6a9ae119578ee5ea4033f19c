...
export const INTENTS: IntentLink[] = [
  ...
  { path: '/intents/anwesenheit-erfassen', label: { de: 'Anwesenheit erfassen', en: 'Record attendance' }, icon: IconClipboardCheck, description: 'Anwesenheit aller angemeldeten Schüler für eine Kursstunde auf einmal eintragen' },
  { path: '/intents/kurs-planen', label: { de: 'Kurs planen', en: 'Plan course' }, icon: IconCalendarPlus, description: 'Neuen Kurs anlegen und einem Dozenten sowie einem passenden Raum zuweisen' },
  // </custom:intents>
];
 ...
 */
export const INTENTS_PENDING_SINCE: string | null = '2026-09-07T08:44:01+00:00';
