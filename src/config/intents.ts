...
export const INTENTS: IntentLink[] = [
  ...
  { path: '/intents/anwesenheit-erfassen', label: { de: 'Anwesenheit erfassen', en: 'Record attendance' }, icon: IconClipboardCheck, description: 'Anwesenheit aller angemeldeten Schüler für eine Kursstunde eintragen' },
  { path: '/intents/kurs-planen', label: { de: 'Kurs planen', en: 'Plan course' }, icon: IconCalendarPlus, description: 'Neuen Kurs für einen Dozenten mit passendem Raum anlegen' },
  // </custom:intents>
];
 ...
 */
export const INTENTS_PENDING_SINCE: string | null = '2026-09-04T15:52:26+00:00';
