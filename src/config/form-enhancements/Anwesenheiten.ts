// Auto-generated. Per-entity form-enhancements config for "Anwesenheiten".
...
export const formEnhancements: FormEnhancements = {
  fieldOrder: ['kurs', 'teilnehmer', 'datum', 'anwesend', 'entschuldigt'],
  defaults: {
    'datum': { kind: 'today' },
    'anwesend': { kind: 'literal', value: true },
  },
  computed: {},
};
