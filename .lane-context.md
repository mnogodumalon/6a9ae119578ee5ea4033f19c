...
### `dozenten` — Dozenten (type `Dozenten`, one record: `DozentenEntry`)
...
- `email` · email · E-Mail
- `telefon` · tel · Telefon
- `instrumente` · textarea · Instrumente
- `aktiv` · bool · Aktiv

### `raeume` — Räume (type `Raeume`, one record: `RaeumeEntry`)
Display fields: `name`
- `name` · text · Name · required! · maxLength 4000
- `plaetze` · number · Plätze · required!
- `klavier_vorhanden` · bool · Klavier vorhanden

### `kurse` — Kurse (type `Kurse`, one record: `KurseEntry`)
Display fields: `titel`
- `titel` · text · Titel · required! · maxLength 4000
- `instrument` · lookup · Instrument · required! · options: klavier | gitarre | violine | cello | querfloete | klarinette | schlagzeug | gesang | blockfloete
- `niveau` · lookup · Niveau · options: anfaenger | fortgeschritten | profi
- `wochentage` · multilookup · Wochentage · options: montag | dienstag | mittwoch | donnerstag | freitag | samstag
- `dozent` · record · Dozent · required! · → `dozenten`
- `raum` · record · Raum · → `raeume`
- `beginn` · date · Beginn · required!
- `ende` · date · Ende
- `uhrzeit` · datetime · Uhrzeit
- `maximale_teilnehmer` · number · Maximale Teilnehmer · required!
- `preis` · number · Preis (Euro) · currency
- `status` · lookup · Status · required! · options: geplant | laeuft | abgeschlossen | abgesagt
Input shapes: range `beginn`+`ende` (AvailabilityRangePicker); choice `niveau` (ChoiceGroup); choice `status` (ChoiceGroup)

### `teilnehmer` — Teilnehmer (type `Teilnehmer`, one record: `TeilnehmerEntry`)
Display fields: `vorname`, `nachname`
- `vorname` · text · Vorname · required! · maxLength 4000
- `nachname` · text · Nachname · required! · maxLength 4000
...
- `email` · email · E-Mail
- `telefon` · tel · Telefon
- `erziehungsberechtigte_person` · text · Erziehungsberechtigte Person · maxLength 4000
- `notizen` · textarea · Notizen

### `anmeldungen` — Anmeldungen (type `Anmeldungen`, one record: `AnmeldungenEntry`)
Display fields: `bemerkung`
- `kurs` · record · Kurs · required! · → `kurse`
- `teilnehmer` · record · Teilnehmer · required! · → `teilnehmer`
- `anmeldedatum` · date · Anmeldedatum · required!
- `status` · lookup · Status · required! · options: abgemeldet | neu | bestaetigt | warteliste
- `bezahlt` · bool · Bezahlt
- `bemerkung` · textarea · Bemerkung
Input shapes: choice `status` (ChoiceGroup)

### `anwesenheiten` — Anwesenheiten (type `Anwesenheiten`, one record: `AnwesenheitenEntry`)
Display fields: `kurs`
- `kurs` · record · Kurs · required! · → `kurse`
- `teilnehmer` · record · Teilnehmer · required! · → `teilnehmer`
- `datum` · date · Datum · required!
- `anwesend` · bool · Anwesend
- `entschuldigt` · bool · Entschuldigt
